use crate::{
    implementation_fingerprint, source_fingerprint, GenericInstanceFingerprint,
    GenericItemFingerprint,
};
use sengoo_compiler::{
    ClassMember, Decl, DeclKind, Expr, ExprKind, Parser, Program, Span, Stmt, StmtKind, TraitItem,
    TypeParam,
};
...
use self::function_fingerprints::{call_target_signature, collect_calls_in_stmt};
