...
|---|---|---:|
| [`01_strings.sg`](01_strings.sg) | Importing `std::string` helpers for append, repeat, equality, and empty checks | `8` |
...
| [`04_option_result.sg`](04_option_result.sg) | Importing `std::option` and `std::result` bool constructors and projections | `7` |
