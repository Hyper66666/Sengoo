# core-language-correctness Specification

## Purpose
Define the pinned core-language conformance surface that must compile to valid
IR, run with documented behavior, and remain guarded by CI.
## Requirements
