# sgplatform Specification

## Purpose
Define the SDL2-backed platform package surface for native window creation,
event polling, frame timing, drawing primitives, and reproducible native
linking.
## Requirements
