# language-default-polish Specification

## Purpose
Define the additive language-polish contract after the main surface expansion:
cfg/deprecated diagnostics, FFI rejection parity, async-frame deferrals,
match/try diagnostic parity, and migration gates for future source-incompatible
cleanup.
