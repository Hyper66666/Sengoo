# async-cancellation Specification

## Purpose
Define the supported cooperative cancellation surface for Sengoo async tasks,
consuming selects, and cancellable process waits.
