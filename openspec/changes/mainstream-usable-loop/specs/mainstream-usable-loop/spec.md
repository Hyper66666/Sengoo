...
### Requirement: Gaps SHALL be classified as supported, unsupported, deferred, or platform-specific
...
- **THEN** it classifies async IO wakeups, user-defined Future support,
  ...
  cancellation boundaries as supported, unsupported, deferred, or
  platform-specific
