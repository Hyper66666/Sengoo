...
| `frontend-1000k-perf-gate` | Archived 2026-06-13 as superseded by archived `compile-scale-production-gate` | Phase 5 re-runs the compile-scale gate after `-g` work to prove no default-mode regression |
