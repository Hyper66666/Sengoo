...
- [ ] 9.5 Hand Senline the clean source revision, target-specific installed-toolchain and worker manifests, complete per-file hashes, SBOM/provenance inputs, and green evidence needed for its reviewed pin.
