...
- [ ] 4.2 Update `tools/stdlib/README.md` collections section.
- [ ] 4.3 Add `examples/stdlib/` programs using `Vec<String>` and a
  `HashMap<String, i64>`.
- [ ] 4.4 Run `openspec validate generic-collections --strict`.
